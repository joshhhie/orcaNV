...
Use **Commands** on the [**Home**](https://github.com/joshhhie/orcaNV#house-home) page (collapsible tabs, right column), action cards on [**Apps**](https://github.com/joshhhie/orcaNV#iphone-apps), or featured scripts on [**Scripts**](https://github.com/joshhhie/orcaNV#newspaper-scripts).
...
- :keyboard: **Commands** - Collapsible tab sections on the right (Flipper spring animations). Tap a header to expand or collapse.

  - **Character** - Refresh, ghost, godmode, freecam, flight, walk speed, jump height
  - **Server** - Rejoin or switch server
  - **Players** - Goto, hide, kill, spectate (select a player on Apps first)
  - **Scripts** - One-tap load Vape V4, Orca, Infinite Yield, CMD-X
  - **Settings** - Acrylic background blur

  Add more in `src/views/Pages/Options/Commands/registry.ts`.
...
The **Options** page lets you configure theming and shortcuts.

- :art: **Options** - Acrylic background blur toggle
